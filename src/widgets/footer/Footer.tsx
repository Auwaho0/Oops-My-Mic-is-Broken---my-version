          ...
          <div className="mt-4 flex flex-wrap gap-3">
            {LINKS.map(({ Icon, label }) => (
              <a
                ...
                className="inline-flex items-center gap-2 border-2 border-paper px-4 py-2 text-xs sm:text-sm transition-all hover:bg-paper hover:text-ink hover:-translate-y-0.5"
              >
